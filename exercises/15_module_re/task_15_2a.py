...
#Решение
from task_15_2 import parse_sh_ip_int_br as par

def convert_to_dict (headers, int_brief):
	return [{headers[j]:i[j] for j in range(4)} for i in int_brief]

print(convert_to_dict(headers,par('sh_ip_int_br.txt')))
